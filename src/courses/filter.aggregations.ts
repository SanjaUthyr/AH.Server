export const aggregations = [
  {
    id: 'price',
    options: [
      { title: 'Paid', value: 'price-paid' },
      { title: 'Free', value: 'price-free' },
    ],
  },
  {
    id: 'level',
  ...
  },
  {
    ...
    options: [
      ...
      { title: 'Azərbaycan dili', value: 'az' },
      { title: 'मराठी', value: 'mr' },
      { title: 'Malayāḷam', value: 'ml' },
      { title: 'فارسی', value: 'fa' },
      { title: 'Українська', value: 'uk' },
      { title: 'Hrvatski', value: 'hr' },
      { title: 'မြန်မာဘာသာ', value: 'my' },
      ...
      { title: 'Қазақша', value: 'kk' },
      { title: 'Lietuvių', value: 'lt' },
      { title: 'Slovenčina', value: 'sk' },
      { title: 'Kiswahili', value: 'sw' },
      { title: 'Gaeilge', value: 'ga' },
      { title: 'ਪੰਜਾਬੀ', value: 'pa' },
      { title: 'Монгол', value: 'mn' },
      { title: 'Khmer', value: 'km' },
      { title: 'Kurdî', value: 'ku' },
      { title: 'Македонски', value: 'mk' },
      { title: 'Qhichwa', value: 'qu' },
      { title: "Avañe'ẽ", value: 'gn' },
      { title: 'Ayisyen', value: 'ht' },
      { title: 'Հայերեն', value: 'hy' },
      { title: 'Slovenščina', value: 'sl' },
      { title: 'Aymar aru', value: 'ay' },
      { title: 'Cymraeg', value: 'cy' },
      { title: 'Euskara', value: 'eu' },
      { title: 'Føroyskt', value: 'fo' },
      { title: 'Frysk', value: 'fy' },
      { title: 'тоҷикӣ, تاجیکی‎, tojikī', value: 'tg' },
      { title: 'татарча / Tatarça / تاتارچا', value: 'tt' },
      { title: 'isiXhosa', value: 'xh' },
  ...
  },
  {
    ...
    title: 'Duration',
    options: [
      { title: '0-1 Hour', value: 'extraShort' },
      { title: '1-3 Hours', value: 'short' },
      { title: '3-6 Hours', value: 'medium' },
      { title: '6-17 Hours', value: 'long' },
      { title: '17+ Hours', value: 'extraLong' },
    ],
  },
];
